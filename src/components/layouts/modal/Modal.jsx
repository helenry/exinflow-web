// components/layouts/modal/Modal.jsx
...
const Modal = () => {
  ...
  return (
    <div
      className={`${MODAL.MARGIN} ${MODAL.HEIGHT} bg-[#e8f8fc] p-4 rounded-2xl flex justify-between items-center`}
    >
      <div className="w-[100%] grid grid-rows-[8fr_84fr_8fr] gap-y-5 h-full">
        <div className="flex items-center justify-between">
          ...
          <CircleButton icon={LuX} onClick={closeModal} />
        </div>

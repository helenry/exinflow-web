// components/menu/category/subcategory/SubcategoryModalButtons.jsx
const SubcategoryModalButtons = ({ validateAndSubmit, onCancel, loading }) => {
  return (
...
export default SubcategoryModalButtons;